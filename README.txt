1) node.js installieren (https://nodejs.org/en/download/)
2) commandline öffnen
3) packages "socket.io" und "express" installieren
   -cd C:/project directory
   -npm install socket.io express --save
4) package "fluent-ffmpeg" installieren
   -cd C:/project directory
   -npm install fluent-ffmpeg ("ffmpeg" muss zuvor lokal installiert sein)
5) server starten
